<template>
  <div :key="currentLanguage">
    <slot>
      <div :class="['TUIKit', isH5 && 'TUIKit-h5']" class="!w-full">
...
import { ref, onMounted, framework } from '@/TUIKit/adapter-vue'
...
import { TUISearch, TUIConversation, TUIChat, TUIContact, TUIGroup } from '@/TUIKit/components'
import { isH5 } from '@/TUIKit/utils/env'
import TUILocales from '@/TUIKit/locales'
...
onMounted(() => {
  ...
  // 直接初始化 TUITranslateService，避免跨模块实例问题
...
@import '@/TUIKit/assets/styles/sample';
</style>
<style lang="scss">
